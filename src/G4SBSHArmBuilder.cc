...
void G4SBSHArmBuilder::MakeSBSSieveSlit(G4LogicalVolume *motherlog)
{
  ...
  SievePlateRot->rotateY(-30.0*deg);
  ...
  */
  ...
  new G4PVPlacement(SievePlateRot, G4ThreeVector(offset_z*sin(PlateAngDisp_theta), 0, offset_z*cos(PlateAngDisp_theta)), SievePlateLog, "SievePlateLog", worldlog, false, 0, ChkOverlaps);
